...
export const sidebarNavigation: NavSection[] = [
  {
    ...
    items: [
      ...
      { titleKey: "nav.testRuns", href: "/test-runs", icon: PlayCircle, iconColor: "text-icon-orange" },
      { titleKey: "nav.executions", href: "/executions", icon: ClipboardCheck, iconColor: "text-muted-foreground" },
